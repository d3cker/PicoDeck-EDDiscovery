...
uint8_t tud_network_mac_address[6] = {0x02, 0x50, 0x44, 0x45, 0x44, 0x01};
...
const char *net_usb_device_ip(void) { return "192.168.7.1"; }
const char *net_usb_host_ip(void) { return "192.168.7.2"; }
