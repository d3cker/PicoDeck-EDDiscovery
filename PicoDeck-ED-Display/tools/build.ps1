...
$uf2 = Join-Path $build "picodeck_ed_display.uf2"
if (-not (Test-Path -LiteralPath $uf2)) {
    throw "Build completed but picodeck_ed_display.uf2 was not produced"
}

$destination = Join-Path $dist "PicoDeck-ED-Display.uf2"
